...
type result = Int of int | Pointer of loc | Bool of bool | Pair of result*result | Func of stm * vname * environment | Array of loc * int | List of loc | ListNode of result * loc;;
